...
#ifndef VLUR_COMPUTE_PIPELINE_H
#define VLUR_COMPUTE_PIPELINE_H
...
// outside of this class.
    ...
    public:
        ...
        static std::unique_ptr<ComputePipeline> create(
                const VulkanContext *context, const char *shader,
        ...
        void recordComputeCommands(
                VkCommandBuffer cmd, const void *pushConstantData,
